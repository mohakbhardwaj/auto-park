...
entrance.pose.orientation.x, entrance.pose.orientation.y, entrance.pose.orientation.z, entrance.pose.orientation.w = tf.transformations.quaternion_from_euler(
        0, 0, 3.14 / 2)
exitc = PoseStamped()
exitc.pose.position.x = 40
exitc.pose.position.y = 46
exitc.pose.position.z = 0
exitc.pose.orientation.x, exitc.pose.orientation.y, exitc.pose.orientation.z, exitc.pose.orientation.w = tf.transformations.quaternion_from_euler(
        0, 0, 3.14 / 2)
...
bogus.pose.orientation.x, bogus.pose.orientation.y, bogus.pose.orientation.z, bogus.pose.orientation.w = tf.transformations.quaternion_from_euler(
        0, 0, 3.14 / 2)
...
def draw_environment():
    ...
    signs.ns = "Signs"
    signs.color.a = 0.8
    signs.pose.orientation.x, signs.pose.orientation.y, signs.pose.orientation.z, signs.pose.orientation.w = [0, 0, 0,
                                                                                                              1]
    ...
    while True:
        ...
        if random() > 0.5:
            for i in range(4):
                boundary.id = i
                boundary.pose.orientation.x, boundary.pose.orientation.y, boundary.pose.orientation.z, boundary.pose.orientation.w = \
                    orientations[i]
